                            ...
                            <div class="card-body">
                                ...
                                <form id="frmGramatica" name="frmGramatica" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea style="overflow-y: scroll; resize:horizontal; width:20pc; height: 8pc;" 
                                                  type="text" name="producciones" id="producciones" required><%= sigma != null ? sigma : ""%></textarea>
                                    </div>
                        ...
                        <div id="opcionesGramatica">
                            <div id="eliminarVariablesInutilesId"> 
                                <p>
                                    ...
                                    <textarea style="overflow:scroll; width:30em; height: 38em;" 
                                              type="text">
